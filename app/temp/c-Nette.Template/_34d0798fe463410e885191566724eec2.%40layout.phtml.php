<?php //netteCache[01]000213a:2:{s:4:"time";s:21:"0.99324500 1267142610";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:58:"D:\www\skusky\document_root/../app/templates/@layout.phtml";i:2;i:1267142201;}}}?><?php
// file …/templates/@layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '66cf5a87f0'); unset($_extends);


//
// block css
//
if (!function_exists($_cb->blocks['css'][] = '_cbb51c5fd5bf2_css')) { function _cbb51c5fd5bf2_css() { extract(func_get_arg(0))
?>
...
// block js
//
if (!function_exists($_cb->blocks['js'][] = '_cbb94878e699e_js')) { function _cbb94878e699e_js() { extract(func_get_arg(0))
?>
...
// block menu
//
if (!function_exists($_cb->blocks['menu'][] = '_cbb02bd8adedc_menu')) { function _cbb02bd8adedc_menu() { extract(func_get_arg(0))
?>
            <div id="navigation">
...
// block popup
//
if (!function_exists($_cb->blocks['popup'][] = '_cbb9629891062_popup')) { function _cbb9629891062_popup() { extract(func_get_arg(0))
